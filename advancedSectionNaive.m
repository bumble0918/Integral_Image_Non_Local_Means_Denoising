...
%Debug with smaller image and stick with non-colour images for now
%the noise level is different for each image (it is 20, 10, and 5 as
...
% Generate the denoised image using Non-Local Mean method
filtered = nonLocalMeansNaive(imageOff, sigma, h, patchSize, searchWindowSize);
toc
...
%      '1_alleyDenoisedNaive_sigma20_h055_patchWidth3_windowWidth11.png']);
...
%Feel free to use some other metrics (Root Mean-Square Error (RMSE), 
%Structural Similarity Index (SSI) etc.)